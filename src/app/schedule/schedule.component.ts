...
export class ScheduleComponent implements OnInit {
  ...
  classCards = [
    ...
    { title: 'Marimba 2', times: "3:30pm - 4:30pm", link: "marimba2", cols: 1, rows: 1, background: this.activeColor },
    ...
    { title: 'Advanced Marimba', times: "4:30pm - 5:45pm", link: "marimba4", cols: 1, rows: 1, background: this.activeColor },
    { title: 'Marimba 3', times: "4:30pm - 5:30pm", link: "marimba3", cols: 1, rows: 1, background: this.activeColor },
